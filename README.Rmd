...
The aim of R-LIMS is to simplify and streamline interacting with D-LIMS at scale, for development projects and for audits.
...
To begin with, set up the ODBC connection which connects to the server mirror version of the DLIMS database using `connect_odbc()`.
